...
let drawingsMap = new Map(); // Map to store drawings
...
function draw(e) {
  ...
  if (!drawingsMap.has(currentDrawingId)) {
    drawingsMap.set(currentDrawingId, []);
  }
  drawingsMap.get(currentDrawingId).push({ x, y });
}
